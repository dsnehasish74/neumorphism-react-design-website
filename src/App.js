...
import './App.css'
function App() {
  const [documentation,setDocument]=useState(<DivContent/>);
  return (
    <Container className="main_container">
      <Div width="200px" height="100vh" padding="0px" radius="0px" className="nav">
          <Text className="first_nav_link" padding="10px" fontSize="20px" fontWeight="600">Installation</Text>
          <Text className="nav_link" padding="10px" fontSize="20px" fontWeight="600">Components</Text>
          <ul className="component_list">
              <li><Text  padding="10px" fontSize="18px" onClick={()=>setDocument(<ErrorComponent/>)}>Avatar</Text></li>
              ...
              <li><Text  padding="10px" fontSize="18px" onClick={()=>setDocument(<ErrorComponent/>)}>Text</Text></li>
              <li><Text  padding="10px" fontSize="18px" onClick={()=>setDocument(<ErrorComponent/>)}>Typography</Text></li>
          </ul>
      </Div>
      <div className="body">
        <div>
